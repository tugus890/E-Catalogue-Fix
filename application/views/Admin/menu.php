        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('Cmenu') ?>" method="POST">
                        <div class="row">
                            <div class="col mb-3">
                                <label for="menu" class="form-label">Masukkan Nama Menu</label>
                                <input type="text" id="menu" name="menu" class="form-control" placeholder="Masukkan Menu" />
                            </div>
                        </div>
