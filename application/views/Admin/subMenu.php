...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <!-- Striped Rows -->
            <div class="card">
                <h5 class="card-header">Sub Menu Management</h5>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('Cmenu/subMenu') ?>" method="POST">
                        <div class="col mb-3">
                        ...
                        <div class="col mb-3 mt-2">
                            <label for="url" class="form-label">Sub Menu Url</label>
                            <input type="text" id="url" name="url" class="form-control" placeholder="Submenu url" />
                        </div>
                        <div class="col mb-3">
                            <label for="icon" class="form-label">Sub Menu Icon</label>
